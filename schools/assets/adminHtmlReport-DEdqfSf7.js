...
</html>`,m=t=>String(t).padStart(2,"0"),H=(t=new Date)=>`${t.getFullYear()}-${m(t.getMonth()+1)}-${m(t.getDate())}-${m(t.getHours())}${m(t.getMinutes())}`;export{N as a,C as b,D as c,P as d,a as e,H as f,v as g,R as h,A as i,E as m,B as p,O as s,I as t};
